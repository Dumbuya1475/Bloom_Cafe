    ...
    <section id="contact" className="py-24 bg-coffee-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-white rounded-3xl overflow-hidden border border-coffee-accent/10 shadow-sm p-4">
          <div className="relative h-96 w-full rounded-2xl overflow-hidden shadow-inner">
            <iframe
              title="Bloom Café Location Map"
              src="https://maps.google.com/maps?q=15%20Wilkinson%20Road,%20Lumley,%20Freetown,%20Sierra%20Leone&t=&z=16&ie=UTF8&iwloc=&output=embed"
              className="w-full h-full border-0 filter grayscale-[15%] contrast-[1.02] brightness-[0.98]"
              allowFullScreen
              loading="lazy"
